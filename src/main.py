...
import csv
# filedialog ya importado arriba

# Asegurar que Python encuentra los módulos (insertar raíz del proyecto)
...
class SmartTaskApp:
    ...
    def _crear_interfaz(self):
        ...
        # Botones de acción superior (Gráficos, Voz, Categorías y Nueva)
        ...
        ttk.Button(btn_frame, text="⚙️ CATEGORÍAS", 
        ...
        # Filtros (HU10) — dinámicos según categorías existentes
        self.filtro_frame = ttk.LabelFrame(main_frame, text="FILTROS", padding="10")
        self.filtro_frame.pack(fill=tk.X, pady=(0, 15))
    ...
    def _construir_filtros(self):
        ...
        categorías actuales de la base de datos. Esto permite que al
        agregar o eliminar categorías, los filtros se actualicen.
        """
        # Limpiar filtros existentes
        for widget in self.filtro_frame.winfo_children():
            widget.destroy()
    ...
    def _gestionar_categorias(self):
        ...
        Permite crear, editar y eliminar categorías desde la interfaz.
        Al cerrar el diálogo, reconstruye los filtros dinámicamente
        y recarga la tabla de tareas.
        """
        try:
